          ...
          {steps.map((step) => (
            <div key={step.number} className="relative flex gap-6">
              <div className="flex flex-col items-center">
                <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-brand-500 text-lg font-bold text-white">
                  {step.number}
                </div>
                <div className="mt-2 h-full w-px bg-brand-200 dark:bg-brand-800" />
              </div>
              <div className="pb-12">
